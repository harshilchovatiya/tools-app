...
from routes import main_routes_bp, qr_code_bp, url_shortener_bp, image_compressor_bp, image_upscaler_bp, file_converter_bp, image_to_text_bp, speedtest_bp, unit_converter_bp, morse_code_bp,color_code_bp
...
def create_app():
    ...
    app.register_blueprint(morse_code_bp)
    app.register_blueprint(color_code_bp)
